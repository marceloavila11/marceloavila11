...
**Frontend:** React (Vite + TypeScript + Tailwind) · Astro
**Cloud / DevOps:** AWS (EC2, S3, Lambda, CloudWatch, IAM) · Docker · Kubernetes
**IA / Data:** AI Generativa · Pandas · Scikit-learn · MLflow · SHAP
